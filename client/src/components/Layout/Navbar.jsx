...
function Navbar() {
  ...
  return (
    <header className="w-full">
      ...
      {/* Top Navbar */}
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 px-4 sm:px-6 lg:px-10 py-3 bg-white border-b border-gray-200">

        <div className="flex items-center gap-2 text-sm text-gray-600 self-start">
          <span>🇮🇳India</span>
        </div>

        <form onSubmit={handleSearch} className="flex items-center w-full lg:w-96 bg-gray-100 rounded-full px-4 py-2 gap-2">
        ...
        <div className="flex flex-wrap items-center gap-3 sm:gap-6 text-sm text-gray-700">
