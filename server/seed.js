...
const seedData = async () => {
  try {
    ...
    await Product.insertMany([
      ...
      { name: 'Organic Red Tomatoes', price: 30, unit: 'per kg', stock: 100, category: vegs, imageURL: 'https://images.unsplash.com/photo-1546094096-0df4bcabd337?w=400', description: 'Farm fresh tomatoes' },
      { name: 'Fresh Cucumber', price: 25, unit: 'per kg', stock: 90, category: vegs, imageURL: 'https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?w=400', description: 'Fresh green cucumber' },
      ...
      { name: 'Fresh Mangoes', price: 150, unit: 'per kg', stock: 60, category: fruits, imageURL: 'https://images.unsplash.com/photo-1553279768-865429fa0078?w=400', description: 'Sweet Alphonso mangoes' },

      // Dairy & Eggs
      { name: 'Fresh Whole Milk', price: 60, unit: 'per litre', stock: 100, category: dairy, imageURL: 'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=400', description: 'Fresh whole milk' },
      ...
      { name: 'Muffin', price: 25, unit: 'per piece', stock: 50, category: bakery, imageURL: 'https://images.unsplash.com/photo-1607958996333-41aef7caefaa?w=400', description: 'Fresh chocolate muffin' },
      { name: 'Baguette', price: 50, unit: 'per piece', stock: 30, category: bakery, imageURL: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc7c?w=400', description: 'Fresh French baguette' },

      // Meat & Fish
      { name: 'Fresh Chicken', price: 200, unit: 'per kg', stock: 50, category: meat, imageURL: 'https://images.unsplash.com/photo-1604503468506-a8da13d82791?w=400', description: 'Fresh farm chicken' },
      { name: 'Salmon Fillet', price: 350, unit: 'per kg', stock: 30, category: meat, imageURL: 'https://images.unsplash.com/photo-1574781330855-d0db8cc6a79c?w=400', description: 'Fresh salmon fillet' },
      { name: 'Prawns', price: 400, unit: 'per kg', stock: 25, category: meat, imageURL: 'https://images.unsplash.com/photo-1565680018434-b513d5e5fd47?w=400', description: 'Fresh prawns' },
      { name: 'Mutton', price: 500, unit: 'per kg', stock: 20, category: meat, imageURL: 'https://images.unsplash.com/photo-1603048297172-c92544798d5a?w=400', description: 'Fresh mutton' },

      // Beverages
      { name: 'Orange Juice', price: 80, unit: 'per litre', stock: 60, category: beverages, imageURL: 'https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?w=400', description: 'Fresh squeezed orange juice' },
      { name: 'Green Tea', price: 120, unit: 'per pack', stock: 80, category: beverages, imageURL: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=400', description: 'Premium green tea' },
      { name: 'Coconut Water', price: 40, unit: 'per piece', stock: 70, category: beverages, imageURL: 'https://images.unsplash.com/photo-1559181567-c3190bda8a41?w=400', description: 'Fresh coconut water' },
      { name: 'Mango Smoothie', price: 90, unit: 'per bottle', stock: 50, category: beverages, imageURL: 'https://images.unsplash.com/photo-1623065422902-30a2d299bbe4?w=400', description: 'Fresh mango smoothie' },

      // Paan Corner
      { name: 'Marlboro Red', price: 210, unit: 'per pack', stock: 100, category: paan, imageURL: 'https://imgs.search.brave.com/a7t66RVxhqYqZqSYHmDUFeNaSHN9l5aN_l4hbMKiIg8/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9pbWFn/ZXMubWVtZS1hcnNl/bmFsLmNvbS80M2M4/NzIxNzJmMGU1MDc5/MjY0YzQ5OGMyODE4/MjU5MS5qcGc', description: 'Marlboro Red Cigarettes' },
      { name: 'Marlboro Advance', price: 115, unit: 'per pack', stock: 100, category: paan, imageURL: 'https://imgs.search.brave.com/jYGW1a3ZnG46fmapekX9hDLJw5G7NLrKXlC-WQ7MAG8/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9pbWFn/ZS5jZG4uc2hweS5p/bi8zMTk1NTEvMTcw/MTQzNzA0MTg5MF8x/LmpwZWc_d2lkdGg9/NjAwJmZvcm1hdD13/ZWJw', description: 'Marlboro Advanced Cigarettes' },
